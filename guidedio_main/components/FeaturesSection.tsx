...
const features = [
  { icon: GraduationCap, title: "Program Recommendation", desc: "AI-matched programs based on your WASSCE grades", color: "bg-[#6baa2b]/10 text-[#6baa2b]" },
  ...
  { icon: School, title: "University Cut-Off Points", desc: "Up-to-date cut-off data for all universities", color: "bg-[#6baa2b]/10 text-[#6baa2b]" },
  ...
  { icon: CalendarCheck, title: "Counseling Booking", desc: "Book sessions with professional academic counselors", color: "bg-[#6baa2b]/10 text-[#6baa2b]" },
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="font-['Sora'] text-3xl md:text-4xl font-bold mb-4 text-[#0d0d0d]">
            What Guidedio <span className="bg-clip-text text-transparent bg-linear-to-r from-[#6baa2b] via-[#2563eb] to-[#141414]">Already Solves</span>
          </h2>
